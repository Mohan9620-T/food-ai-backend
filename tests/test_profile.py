def _headers(client, email="profile@example.com"):
    client.post("/users/", json={"fullname": "Profile User", "email": email, "password": "profile-password"})
...
def test_profile_get_404_then_upsert_and_update(client):
    ...
    payload = {
        "goal": "lose_weight", "target_calories": 1800, "target_protein_g": 120,
        "target_carbs_g": None, "target_fat_g": 60,
